...
- (void)setupView {
    ...
    NSArray *arrLb = @[_lngLb,_latLb,_speedLb,_offlineTimeLb,_stayTimeLb,_stayCountLb,_doorLb,_accLb,_oilLb,_mileageLb,_inElectriLb,
        _outElectriLb,_bfLb,_cfLb,_lowElectricWarmLb,_mqWarmLb,_ddWarmLb,_overSpeedWarmLb,_zdWarmLb,_yljcWarmLb,
                             _gpsDriftLb,_ydControlLb,_vibrationLb,_accNoticeLb,_timeZone,_sleepModelLb,_gpsNumberLb,_gsmNumberLb,_timeLb,_addressLabel];//_warmTypeLb
    [self restMutableArray:self.arrayLb addFromArray:arrLb];

    NSArray *arrT = @[@"经度:",@"纬度:",@"速度:",@"离线时长:0分",@"停留时长:0分",@"停留次数:0分",@"门状态:关",@"acc状态：关",@"油量:0L 0%",@"当天里程:0km",@"内电:关",@"外电:开",@"布防:开",@"撤防:开",@"低电报警:开",@"盲区报警:开",@"掉电报警:开",@"超速报警:开",@"振动报警:开",@"油量检测报警:开",@"GPS漂移抑制:开",@"油电控制:开",@"振动灵敏度:高",@"ACC工作通知:开",@"终端时区:8",@"休眠模式：时间休眠",@"GPS:0颗",@"GSM:27",@"上报时间:2020-05-18 13:35:32",@"四川省成都市高新区长虹科技大厦"];//@"报警类型:8"
...
- (void)setupView_warmed {
    ...
    NSArray *arrT = @[@"经度:",@"纬度:",@"速度:",@"离线时长:0分",@"停留时长:0分",@"停留次数:0分",@"门状态:关",@"acc状态：关",@"油量:0L 0%",@"当天里程:0km",@"内电:关",@"外电:开",@"布防:开",@"撤防:开",@"低电报警:开",@"盲区报警:开",@"掉电报警:开",@"超速报警:开",@"振动报警:开",@"油量检测报警:开",@"GPS漂移抑制:开",@"油电控制:开",@"振动灵敏度:高",@"ACC工作通知:开",@"终端时区:8",@"休眠模式：时间休眠",@"GPS:0颗",@"GSM:27",@"报警类型:8",@"上报时间:2020-05-18 13:35:32",@"四川省成都市高新区长虹科技大厦"];
    [self restMutableArray:self.arrayTitles addFromArray:arrT];
...
- (void)setDeviceInfoModel:(DeviceDetailModel *)deviceInfoModel {
    ...
    if (deviceInfoModel) {
        ...
        _lngLb.text = [NSString stringWithFormat:@"%@%@",Localized(@"经度:"),deviceInfoModel.lng];
