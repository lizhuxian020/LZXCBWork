...
class CBPetChatPetmessageView: CBPetBaseView, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc private func notificationMethodTableViewScrollEable(notifi:Notification) {
        ...
        if (result as! Bool) == true {
            self.petMessageTableView.isScrollEnabled = true
        } else {
            self.petMessageTableView.isScrollEnabled = false
        }
    }
